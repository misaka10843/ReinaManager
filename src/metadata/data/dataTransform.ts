...
export function getDisplayGameData(fullData: FullGameData): GameData {
	...
	const baseData: GameData = {
		...
		launch_type: fullData.launch_type ?? "local",
		steam_app_id: nullToUndefined(fullData.steam_app_id),
		steam_process_path: nullToUndefined(fullData.steam_process_path),
